...
import com.project.bookuluv.domain.rebate.domain.RebateService;
...
//    }
    ...
    @PostMapping("/admin/rebate")
    public String rebate(@RequestParam String period, Model model){
        List<RebateOrderItem> rebateItems = this.rebateService.calculateRebateData(period);

        model.addAttribute("rebateItems", rebateItems);
